              ...
              <div class="row">
                ...
                <div className="col-md-8">
                  <div class="card text-white bg-success" style={{styles}}>
                    <img class="custom-pressure-img-top" src="/pressure-sensornew.jpg" alt="pressure sensor icon"/>
                    <div class="card-body">
                      <h3 class="card-title">Pressure Sensor</h3>
                      <p class="card-text"></p>
                    </div>
                    <ul class="list-group list-group-flush">
                      <li class="list-group-item">Pressure Reading: <b>{this.state.pressure} <strong>N/m</strong><sup>2</sup></b></li>
                    ...
                    />
                    <form>
                        <label htmlFor="Pressure Input">Pressure Input:</label>
